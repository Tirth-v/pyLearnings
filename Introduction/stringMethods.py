...
"""
         ...
         - We can concatenate strings using following ways
         ...
         - strings are immutable so whenever it is
           concatenated, it is assigned to a new variable.
...
"""
    ...
    print("{x} move ahead, {a} work hard, {a} succeed!".format(x="you"))
